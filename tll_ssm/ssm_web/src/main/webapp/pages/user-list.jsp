            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <%--</div>--%>
                        <div class="box-tools pull-right">
                            <form action="${pageContext.request.contextPath}/user/findByInfo.do?page=1&size=${pageInfo.pageSize}" method="post">
                                <input type="text" class="col-xs-2" value="${userInfo.username}" name="username" placeholder="用户名">
                                <input type="text" class="col-xs-2" value="${userInfo.email}" name="email" placeholder="邮箱">
                                <input type="text" class="col-xs-2" value="${userInfo.phoneNum}" name="phoneNum" placeholder="联系电话">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共 ${pageInfo.pages}页，共${pageInfo.total} 条数据， 当前页码为【${pageInfo.pageNum}】。 每页 <select
                                class="form-control" id="changePageSize" onchange="changePageSize()">
                            <option>-请选择分页条数</option>
                            <option>4</option>
                            <option>6</option>
                            <option>8</option>
                            <option>10</option>
