                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <div class="box-tools pull-right">
                            <form action="${pageContext.request.contextPath}/product/findByName.do?page=1&size=${pageInfo.pageSize}"
                                  method="post">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control input-sm" name="productName" placeholder="产品名称">
